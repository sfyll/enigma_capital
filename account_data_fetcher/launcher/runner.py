...
class Runner(RunnerBase):
    def __init__(self, pwd: str, logger: Logger | None = None):
        """
    ...
    def _get_fetcher_instances(
        self, session: aiohttp.ClientSession, exchanges_list: list[str]
        ...
        for name in exchanges_list:
            ...
            FetcherClass = module.DataFetcher
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Get Data Of Interest", formatter_class=argparse.ArgumentDefaultsHelpFormatter
    )
    ...
    parser.add_argument(
        "--exchanges", dest="exchanges", type=str, nargs="+", required=True, help="List of exchange to fetch for"
    )
